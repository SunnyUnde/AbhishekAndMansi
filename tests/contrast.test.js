...
const PAIRS = [
  ...
  ["venue line and invitation on the card (lightest stop)", inkSoft, paperHi],
  ["venue line and invitation on the card (middle stop)", inkSoft, cream],
  ["venue line and invitation on the card (darkest stop)", inkSoft, paperLo],
